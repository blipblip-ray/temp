...
export default function FixtureDetail() {
  ...
  async function confirm() {
    ...
    try {
      await placeBet({ fixture_id: f.id, market: sel.market, selection: sel.selection, stake })
      setMsg({ kind: 'ok', text: `Bet placed: ${sel.label} for ${stake} ₹ at ${sel.odds} (returns ${payout} ₹).` })
      setSel(null)
    } catch (e) {
